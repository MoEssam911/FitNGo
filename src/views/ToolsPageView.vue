<template>
  <main class="container relative">
    ...
    <div
      class="fixed right-[5%] top-1/2 lg:hidden border hover:text-white hover:bg-primary rounded-full p-3 bg-secondary cursor-pointer transition duration-300 w-12 h-12 scale-110 text-center"
      @click="toggleIconsHandler">
      <i class="fa-solid fa-arrow-up" v-if="toggleIcons"></i>
...
export default {
  ...
  // provide() {
  //   return {
  //     toggleBmrClass: this.toggleBmrClass,
  //     toggleMacroClass: this.toggleMacroClass,
  //     toggleFatClass: this.toggleFatClass,
  //     toggleDeitClass: this.toggleDeitClass,
  //   };
  // },
