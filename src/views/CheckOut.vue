  ...
  <div class="container grid font-manrope mb-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
      <div class="md:col-span-1 lg:col-span-1">
        ...
        <div class="mt-4">
          <button
            class=" btn-more-to-explore font-bold px-6 py-2 rounded-lg transition self-center"
          >
            PayPal
          </button>

          <button
            class="btn-more-to-explore m-[6%] text-[white] bg-primary transition font-bold 
            py-2 px-4 rounded-lg self-center"
          >
            CridetCard
          </button>
        ...
        <div>
          ...
          <form action="">
            ...
            <div>
              <input
                class="cell w-full md:w-60 lg:w-60 h-8 border m-2 px-3 py-2"
                type="text"
          ...
          <div class="flex h-8 gap-1">
            ...
            <div>
              <input
                class="cell w-full md:w-16 lg:w-16 h-8 border m-2 px-3 py-2"
                placeholder="CVC"
              />
            </div>
          </div>
        ...
        <button
          class=" btn-more-to-explore bg-primary text-white py-2 rounded mt-16 
          mb-8 w-full md:w-80 lg:w-80"
        >
          Pay with card
        </button>
      </div>
