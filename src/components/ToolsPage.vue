  ...
  <div class="container h-max">
    <div class="flex gap-2 m-5 items-center cursor-pointer">
      ...
      <div class="flex gap-5 mt-10">
        <div
          class="lg:w-60 lg:h-96 bg-secondary bg-opacity-50 rounded-3xl flex flex-col">
          ...
          <div class="mt-5 flex flex-col gap-3 text-center">
            <div class="flex items-center gap-2 hover:bg-secondary cursor-pointer">
              <div>
                <svg
                  width="30"
                  height="34"
            ...
            <div class="flex items-center gap-2 bg-secondary">
              <div>
                <svg
                  width="30"
                  height="34"
        ...
        <div class="w-full">
          <div class="h-44 w-full flex justify-evenly gap-2">
            <div
              class="bg-secondary bg-opacity-50 w-1/4 h-full rounded-3xl hover:bg-primary hover:cursor-pointer flex flex-col justify-center items-center group">
