      ...
      <div class="flex gap-5">
        <div class="w-full">
          ...
          <div
            ...
            <div>
              <router-link
                :to="`/TrainerAccount/EditUser/${user.id}/WorkoutsPlans`"
                ><i
                  class="fa-solid fa-arrow-left hover:text-primary transition duration-200 cursor-pointer text-lg"></i
              ></router-link>
            </div>
            <table
              ...
              <thead class="text-xs uppercase">
                <tr class="border-b">
                  <td
                    ...
                    <input
                      type="text"
                      v-model="fullTable.month"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary w-10/12 p-2.5" />
                  </td>
                </tr>
                <tr class="bg-primary text-white tracking-wider">
                  <th scope="col" class="px-2 lg:px-6 py-3 w-2/12">Id</th>
                  <th scope="col" class="px-2 lg:px-6 py-3 w-6/12">
                    Exercises
                  </th>
              ...
              <tbody>
                <tr
                  class="border-b"
                  v-for="(ex, index) in fullTable.table"
                  :key="ex">
                  <th
                    scope="row"
                  ...
                  <td class="px-2 lg:px-6 py-4">
                    <i
                      class="fa-solid fa-plus text-green-500 cursor-pointer"
                      @click="AddRow"></i>
                    <i
                      class="fa-solid fa-trash text-primary ml-4 cursor-pointer"
            ...
            <button
              class="btn-primary-hover text-white font-bold"
              @click="submit()">
              Submit Plan
            </button>
            <div></div>
