        ...
        <div class="flex gap-5 mt-10">
          ...
          <div class="w-full">
            <div class="h-44 w-full flex justify-evenly gap-2">
              <div
                class="bg-zinc-300 bg-opacity-50 w-1/4 h-full rounded-3xl hover:bg-primary hover:cursor-pointer flex flex-col justify-center items-center group">
              ...
              <div
                ...
                <div
                  class="font-Manrope font-bold group-hover:text-white text-sm">
                  Body Fat Calculator
                </div>
              </div>
            </div>
            ...
            <div
              class="flex flex-col flex-wrap h-auto my-5 w-full bg-zinc-300 bg-opacity-50 rounded-3xl">
              <div>
                <h2 class="text-2xl font-bold pt-6 pl-6">Body Fat Calculator</h2>
                <form @submit.prevent="fetchAPI">
                  ...
                  <div class="flex justify-around flex-wrap items-end">
                    <div class="m-5 w-64">
                      <label class="block mb-2 text-sm font-medium text-gray-900">
                        Waist
                      </label>
                      <input
                        ...
                        type="number"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-64 p-2.5"
                        placeholder="From 40cm to 130cm"
                        required
                        min="40"
                        max="130" />
                    </div>
              ...
              <div class="flex mx-10 font-Manrope text-gray-700 text-md">
                <div class="text-xl" v-if="submitted">
                  <h1>
                    Body Fat Calculator<h2 class="font-extrabold">Body Fat (BMI method)</h2>
                ...
                <div v-else>
                  <p class="py-4">
                    <span class="font-extrabold">* The Body Fat Calculator</span> This body fat calculator estimates your body's percentage of body fat and discovers how much you would need to weigh for a healthy amount of body fat.
                  </p>
                </div>
              </div>
            </div>
...
async function fetchAPI() {
  try {
    ...
    console.log(weight.value, height.value, age.value, gender.value, waist.value, neck.value, hip.value)
