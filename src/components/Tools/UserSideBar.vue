<template>
  ...
  <div class="overflow-hidden">
    <div
      class="h-auto bg-secondary bg-opacity-50 rounded-3xl py-9 flex flex-col justify-center"
      :class="toggle">
      <div class="mx-auto">
        <img
      ...
      <p class="font-Manrope font-bold text-primary text-2xl text-center py-3">
        Ali Maher
      </p>
      ...
      <div class="mt-5 flex flex-col">
        <div
          ...
          <h2 class="font-Manrope font-semibold text-base">Get Trainer</h2>
        </div>
        <div
          class="heading flex items-center gap-4 hover:bg-primary hover:text-white py-3 cursor-pointer">
          <div class="pl-5">
          ...
          <h2 class="font-Manrope font-semibold text-base">My Plan</h2>
        </div>
        <div
          class="heading flex items-center gap-4 hover:bg-primary hover:text-white py-3 cursor-pointer">
          <div class="pl-5">
          ...
          <h2 class="font-Manrope font-semibold text-base">My Shop</h2>
        </div>
        <div
          class="heading flex items-center gap-4 hover:bg-primary hover:text-white py-3 cursor-pointer">
          <div class="pl-5">
          ...
          <h2 class="font-Manrope font-semibold text-base">Tools</h2>
        </div>
      </div>
    </div>
  </div>
